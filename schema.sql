...
\restrict 9gUEPck1sgVHricl8zvO92rSML3uTrGHoIDYE2jKnFnTacpWOj5lsTmDOr8yXx8
...
--
-- Name: battery_movements; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: battery_movements_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--
...
--
-- Name: battery_movements_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
--
-- Name: section_access; Type: TABLE; Schema: public; Owner: -
--

CREATE TABLE public.section_access (
    user_id integer NOT NULL,
    can_view_batteries boolean DEFAULT true NOT NULL,
    can_manage_batteries boolean DEFAULT false NOT NULL,
    can_view_sites boolean DEFAULT true NOT NULL,
    can_manage_sites boolean DEFAULT false NOT NULL,
...
--
-- Name: battery_movements id; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Name: batteries batteries_battery_number_key; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: battery_movements battery_movements_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: role_permissions role_permissions_role_id_section_action_key; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.role_permissions
    ADD CONSTRAINT role_permissions_role_id_section_action_key UNIQUE (role_id, section, action);
...
--
-- Name: section_access section_access_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.section_access
    ADD CONSTRAINT section_access_pkey PRIMARY KEY (user_id);
...
--
-- Name: one_home_base_idx; Type: INDEX; Schema: public; Owner: -
--
...
--
-- Name: battery_movements battery_movements_battery_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: battery_movements battery_movements_from_location_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: battery_movements battery_movements_moved_by_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--

ALTER TABLE ONLY public.battery_movements
    ADD CONSTRAINT battery_movements_moved_by_user_id_fkey FOREIGN KEY (moved_by_user_id) REFERENCES public.users(id);


--
-- Name: battery_movements battery_movements_to_location_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: section_access section_access_user_id_fkey; Type: FK CONSTRAINT; Schema: public; Owner: -
--
...
\unrestrict 9gUEPck1sgVHricl8zvO92rSML3uTrGHoIDYE2jKnFnTacpWOj5lsTmDOr8yXx8
